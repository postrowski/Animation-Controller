...
public class AnimationSequence
{
   ...
   public String               beginKeyFrame = "";
   public String               endKeyFrame   = "";
   public List<String> positiveAttributes = new ArrayList<>();
   public List<String> negativeAttributes = new ArrayList<>();
   ...
   public int score(List<String> positiveRequirement, int positiveWeight,
      ...
      for (String posReq : positiveRequirement) {
         if (positiveAttributes.contains(posReq)) {
            score += positiveWeight;
         }
      }
      for (String negReq : negativeRequirements) {
         if (negativeAttributes.contains(negReq)) {
