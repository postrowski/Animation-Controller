...
public class Helper
{
   ...
   {
      return createComposite(parent, hSpan, style, 0);
   }
   public static Composite createComposite(Composite parent, int hSpan, int gridDataStyle, int compositeStyle)
   {
      Composite block = new Composite(parent, compositeStyle);
   ...
   public Text createText(Composite parent, String name, boolean editable, int hSpan) {
      return createText(parent, name, editable, hSpan, null);
   }
   public Text createText(Composite parent, String name, boolean editable, int hSpan, FontData fontData) {
